...
17 | socket | sys_socket | 3 | int family | int type | int protocol | - | - | - | - |
18 | stat | sys_newstat, compat_sys_newstat | 2 | const char __user * filename | struct __old_kernel_stat __user * statbuf | - | - | - | - | - |
18 | newstat | sys_newstat, compat_sys_newstat | 2 | const char __user * filename | struct stat __user * statbuf | - | - | - | - | - |
...
22 | bind | sys_bind | 3 | int fd | struct sockaddr __user * umyaddr | int addrlen | - | - | - | - |
...
28 | fstat | sys_newfstat, compat_sys_newfstat | 2 | unsigned int fd | struct __old_kernel_stat __user * statbuf | - | - | - | - | - |
28 | newfstat | sys_newfstat, compat_sys_newfstat | 2 | unsigned int fd | struct stat __user * statbuf | - | - | - | - | - |
...
31 | connect | sys_connect | 3 | int fd | struct sockaddr __user * uservaddr | int addrlen | - | - | - | - |
32 | listen | sys_listen | 2 | int fd | int backlog | - | - | - | - | - |
33 | access | sys_access | 2 | const char __user * filename | int mode | - | - | - | - | - |
34 | nice | sys_nice | 1 | int increment | - | - | - | - | - | - |
35 | accept | sys_accept | 3 | int fd | struct sockaddr __user * upeer_sockaddr | int __user * upeer_addrlen | - | - | - | - |
36 | sync | sys_sync | 0 | - | - | - | - | - | - | - |
...
120 | clone | sys_clone_wrapper | 5 | unsigned long clone_flags | unsigned long newsp | int __user * parent_tidptr | int __user * child_tidptr | unsigned long tls | - | - |
...
201 | getdents64 | sys_getdents64 | 3 | unsigned int fd | struct linux_dirent64 __user * dirent | unsigned int count | - | - | - | - |
...
241 | getxattr | sys_getxattr | 4 | const char __user * pathname | const char __user * name | void __user * value | size_t size | - | - | - |
...
261 | get_mempolicy | sys_get_mempolicy | 5 | int __user * policy | unsigned long __user * nmask | unsigned long maxnode | unsigned long addr | unsigned long flags | - | - |
...
291 | splice | sys_splice | 6 | int fd_in | loff_t __user * off_in | int fd_out | loff_t __user * off_out | size_t len | unsigned int flags | - |
...
323 | fanotify_mark | sys_fanotify_mark, sys32_fanotify_mark | 5 | int fanotify_fd | unsigned int flags | __u64 mask | int dfd | const char __user * pathname | - | - |
...
352 | pkey_alloc | sys_pkey_alloc | 2 | unsigned long flags | unsigned long init_val | - | - | - | - | - |
